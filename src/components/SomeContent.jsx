...
const SomeContent = () => {
  ...
  return (
    <div className="someContentMain">
      <div className="someContentTop" data-aos="fade-bottom">
        <p className='someContentHeading'>Some More <br /> Content Goes Here</p>
        <p className='someContentParagraph' data-aos="fade-bottom">Nunc donec sed nunc sit pharetra id nunc <br className='brClass' />elementum.
